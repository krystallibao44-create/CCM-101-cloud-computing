...
AWS offers the broadest range of services, with more than 200 managed services covering compute, storage, databases, AI, and security. It also has the largest partner ecosystem and the most mature, feature-rich offerings, as it was the first major cloud provider and has therefore had more time to expand its catalog.

**2. Which cloud platform would you recommend for an organization that primarily uses Microsoft products? Why?**

Microsoft Azure would be the best choice for an organization built around Microsoft products. It integrates seamlessly with tools such as Microsoft 365, Active Directory (now Entra ID), and Windows Server, making it easier to manage identities, licensing, and workflows across the organization.

**3. Which platform is widely recognized for AI, Machine Learning, and Kubernetes services?**

Google Cloud Platform is widely recognized in this space. It offers strong data analytics tools such as BigQuery, advanced machine learning capabilities, and Google Kubernetes Engine (GKE), which is considered one of the best managed Kubernetes services available.

**4. What similarities did you observe among the three cloud providers?**

All three providers offer equivalent core services under different names — virtual machines for compute, object, block, and file storage options, virtual networks with load balancing and CDN support, and dedicated IAM systems for access control. They also follow a pay-as-you-go pricing model and provide global data center coverage to support scalability and redundancy.
